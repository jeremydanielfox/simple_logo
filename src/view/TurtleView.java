...
public class TurtleView implements Drawer, Configurable {
    private Map<Integer, Image> turtleImages = new HashMap<>();
    ...
    private Image defaultTurtleImage = new Image("images/plain-turtle-small.png",
    ...
    public TurtleView () {
        ...
        this.turtleImages.put(1, new Image("images/ArcaneTower.png"));
        this.turtleImages.put(2, new Image("images/brain.png"));
    ...
    public void drawRotatedTurtle (GraphicsContext gc, double angle,
        ...
        Image image = defaultTurtleImage;
    ...
    public void drawTurtle (Point2D location, double heading, int id) {
        ...
        if (!turtleImages.containsKey(id))
            turtleImages.put(id, defaultTurtleImage);
        image = this.turtleImages.get(id);
