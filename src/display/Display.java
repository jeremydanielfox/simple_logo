...
public class Display {
	...
	private Node makeTurtleView() {
		Canvas tv = new Canvas(Integer.parseInt(myValues.getString("TV_Width")), Integer.parseInt(myValues.getString("TV_Height")));
		return tv;
	}
	...
	private Menu makeMenu(String name) throws NoSuchMethodException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
